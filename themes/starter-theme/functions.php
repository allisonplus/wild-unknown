...
function starter_theme_setup() {
	...
	register_nav_menus( array(
		...
		'mobile'  => esc_html__( 'Optional Mobile Menu', 'starter-theme' ),
	) );
	...
	add_editor_style( array( 'editor-style.css', starter_theme_font_url() ) );
...
function starter_theme_widgets_init() {
	...
	// Define sidebars
	$sidebars = array(
		'sidebar-1'  => esc_html__( 'Sidebar 1', 'starter-theme' ),
	//	'sidebar-2'  => esc_html__( 'Sidebar 2', 'starter-theme' ),
	//	'sidebar-3'  => esc_html__( 'Sidebar 3', 'starter-theme' ),
	);
	...
	foreach ( $sidebars as $sidebar_id => $sidebar_name ) {
		register_sidebar( array(
			'name'          => $sidebar_name,
			'id'            => $sidebar_id,
			'description'   => sprintf ( esc_html__( 'Widget area for %s', 'starter-theme' ), $sidebar_name ),
