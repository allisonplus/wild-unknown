...
gulp.task('clean:pot', function() {
	return del(['languages/project-name.pot']);
});
...
gulp.task('wp-pot', ['clean:pot'], function() {
	...
	.pipe(wpPot({
		...
		bugReport: 'http://starter-theme.dev',
		lastTranslator: 'John Doe <mail@starter-theme.dev>',
		team: 'Team <mail@starter-theme.dev>'
	}))
...
gulp.task('watch', function() {
	...
	browserSync({
		...
		proxy: "testing.dev",         // Use http://starter-theme.dev:3000 to use BrowserSync
		watchOptions: {
